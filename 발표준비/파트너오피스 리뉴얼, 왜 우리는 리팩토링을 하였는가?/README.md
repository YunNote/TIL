...
>
> 
> #### 🔥 코드 컨벤션도 이상한거 같기도 하고 축약어도 쓰면안되는데 일단 이렇게 되있었으니 그냥 쓰자!
> > 동료 A : 이 생각을 한 순간부터 뭔가 꺼림찍합니다! 
>
...
처음 코드를 제대로 확인하기 전까지는 `왜? 잘 돌아가는데 굳이 개선하려는 이유가 뭐지? ` , ` 금방 바꿀 수 있을거 같은데?`, `여기 이렇게 저렇게 건드리면 될꺼야` 와 같은 생각을 했습니다.

![img_3.png](img_3.png)

하지만 팀원들과 다같이 모여 직접 코드를 보고 `자! 이제 코드 개선해보자` 라고 생각하자마자 우리의 생각이 틀렸다는것을 알게되었고.
고민에 빠지게 되었습니다.
